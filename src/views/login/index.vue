				...
				this.$refs.loginForm.validate(valid => {
					if(valid) {
						...
						this.$store.dispatch('LoginByUsername', this.loginForm).then(() => {
							...
							this.$axios.post(this.Global.ServerSrc + '/admin/login', this.loginForm).then(function(Res) {
								console.log(Res)
								This.loading = false
								This.$cookie.set('Token', Res.Token, {
									expires: Res.Expires
								})
								This.$cookie.set('UserInfo', Res.UserInfo, {
									expires: Res.Expires
								})
								...
								} else if(Res.State == 'PassWordError') {
									This.$message({
										message: '密码错误',
										type: 'warning'
									});
